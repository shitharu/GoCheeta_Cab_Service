<%-- 
    Document   : insertcartravel
    Created on : Sep 17, 2022, 1:23:58 PM
...
hr {
  ...
  margin-bottom: 25px;
    ...
    <body>
        <form class="modal-content" action="processcar.jsp" method="post">
        <div class="container">
          <h1>Car Travel Registration Form,</h1>
          <h4>Please fill in this to register car travel details.</h4>
          <hr>
        
            <label for="carid">Car ID</label><br>
            <input type="text" id="carid" name="carid" placeholder="Enter Car ID" required><br>
